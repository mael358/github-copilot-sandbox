...
activities = {
    ...
    "Soccer Club": {
        "description": "Build teamwork and skills through soccer practice and matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 24,
        "participants": ["alex@mergington.edu", "mia@mergington.edu"]
    },
    "Swimming Team": {
        "description": "Train in swimming techniques, endurance, and competition",
        "schedule": "Mondays, Wednesdays, Fridays, 6:00 AM - 7:30 AM",
        "max_participants": 16,
